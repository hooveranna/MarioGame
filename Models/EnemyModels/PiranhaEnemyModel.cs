...
{
    class PiranhaEnemyModel : EnemyModel
    {
        public PiranhaEnemyModel(ItemEnemySpriteFactory itemEnemySpriteFactory, Vector2 coordinates, Vector2 velocity)
            : base(itemEnemySpriteFactory)
        {
            Time = new System.Diagnostics.Stopwatch();
            Texture = ItemEnemySpriteFactory.GetEnemySprite("piranha");
            //Initialize state first
            CurrentState = new PiranhaStandardState(this);
        ...
        public override void CollisionResponseTop(ICollidable collidable)
        {
            ...
            {
                MarioModel mario = (MarioModel)collidable;
                mario.TakeDamage();
            }
        }
/*
